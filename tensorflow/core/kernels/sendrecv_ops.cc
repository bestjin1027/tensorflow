...
REGISTER_KERNEL_BUILDER(Name("_Send").Device(DEVICE_SGX), SendOp);
...
REGISTER_KERNEL_BUILDER(Name("_Recv").Device(DEVICE_SGX), RecvOp);
...
REGISTER_KERNEL_BUILDER(
    Name("_HostRecv").Device(DEVICE_SGX).HostMemory("tensor"), RecvOp);
